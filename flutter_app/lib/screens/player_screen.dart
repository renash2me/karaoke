      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text('Score: ${_scoreCalc.score} pts', style: const TextStyle(fontSize: 20)),
            Text('Precisão: ${(_scoreCalc.accuracy * 100).toStringAsFixed(1)}%'),
          ],
        ),
        actions: [
          TextButton(
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // Área da letra (placeholder — CDG renderer seria aqui)
            Expanded(
              child: Container(
                color: Colors.black,
                child: const Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 16),
                      Text(
                        'Letra sincronizada aqui',
                        style: TextStyle(color: Colors.white38, fontSize: 18),
                      ),
                      Text(
                        '(renderização CDG — Fase 2)',
                      ...
                      Expanded(
                        child: Slider(
                          value: _duration.inSeconds > 0
                              ...
                              : 0,
                          onChanged: (v) {
                            _player.seek(Duration(seconds: (v * _duration.inSeconds).round()));
                          },
